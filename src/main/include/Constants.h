...
constexpr int kFrontLeftMotorPort = 2;
constexpr int kRearLeftMotorPort = 4;
...
constexpr auto kTrackWidth =
    0.64_m;  // Distance between centers of right and left wheels on robot presumably in meters
constexpr auto kWheelBase =
    0.515_m;  // Distance between centers of front and back wheels on robot presumably in meters
